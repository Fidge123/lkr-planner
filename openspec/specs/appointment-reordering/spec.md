...
Give planners control over the order of an employee's assignments within a day, through a persisted order index that drives both the rendered card order and the allocated time slots, and let drags place a card at an exact position inside its own or another day cell.
