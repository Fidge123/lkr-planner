use super::super::local_store::{
    DayliteContactCacheEntry, DayliteContactUrl, EmployeeSetting, LocalStore,
};
...
mod tests {
    ...
    use crate::integrations::local_store::{DayliteContactCacheEntry, EmployeeSetting, LocalStore};
